...
def usrgenerate():
    if request.method == "POST":
        ...
        # lolx(sentences)
        # print(sentences)
        # strr = f'{"sente": {sentences}}'
        # json_object = json.loads(strr)
        # print(type(json_object))
        # with open("client/src/data/sample.json", "w", encoding='utf8') as outfile:
        #     json.dump(request.json, outfile, indent=4, ensure_ascii=False)
        #     outfile.close()
