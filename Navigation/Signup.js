  ...
  return (
    ...
    <div class="adcontent">
        <form action="http://localhost:9999/signup" method="post">
          ...
          <div class="headname"><h1>SIGN UP</h1></div>
          ...
          <div class="radio2">
            <p>Reviewer role:&nbsp;&nbsp;
            <input type="radio" id="reviewer_role" name="reviewer_role" value = "Yes" />
            <label for="reviewer_role">Yes</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="radio" id="reviewer_role" name="reviewer_role" value="No" />
            <label for="reviewer_role">No</label></p>
          </div>
