  ...
  return (
    <>
      ...
      <p className="lab_discourse">Discourse</p>
        ...
        <input id="discourse_name" name="discourse_name" type="text"  onChange={handleMessageChange} />
        </div>
        <div className="ttab2"><input type='submit'  name="Save Sentences"  value="Save discourse" disabled={!sentences} onClick={getData} /></div>
        <div className="ttab1"><input type='submit' name="Generate USR"  value="USR Generate" disabled={!sentences} onClick={getData} /></div>
        <div style={{ display: showIframe ? 'block' : 'none' }}>
          <iframe className="outl" width="500" height="540" title="sentence" src="/sentences/" />
